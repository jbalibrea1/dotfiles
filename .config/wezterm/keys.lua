  ...
  config.keys = {
    {
      ...
      action = wezterm.action.SpawnCommandInNewTab {
        args = { 'wezterm', 'ssh', 'hetzner' },
      },
    },
    { key = 'F2', action = wezterm.action.SpawnTab 'DefaultDomain' },
    -- Scrollback
    ...
    { mods = M.mod, key = 'q', action = act.CloseCurrentTab { confirm = true } },
    ...
    M.split_nav('move', 'SUPER|CTRL', 'h', 'Left'),
    M.split_nav('move', 'SUPER|CTRL', 'j', 'Down'),
    M.split_nav('move', 'SUPER|CTRL', 'k', 'Up'),
    M.split_nav('move', 'SUPER|CTRL', 'l', 'Right'),
  }
end
