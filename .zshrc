...
plugins=(sudo git z zsh-syntax-highlighting zsh-autosuggestions fzf)

#fzf
export FZF_DEFAULT_OPTS='--height 40% --layout=reverse --border'
#export FZF_TMUX_OPTS='--height 40% --layout=reverse --border'
export FZF_TMUX=0
...
alias l='eza'
alias la='eza -a'
alias ls='eza --grid --color=auto --icons=always'
